...
Add live web search and page extraction to a <a href="https://docs.cartesia.ai/line/sdk/agents" target="_blank">Cartesia Line</a> voice agent using <a href="https://docs.cartesia.ai/line/sdk/tools" target="_blank">loopback tools</a> backed by <a href="https://docs.tavily.com" target="_blank">Tavily</a>. The agent can answer questions about current events, fresh facts, and specific URLs mid-call.
