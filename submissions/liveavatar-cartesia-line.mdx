...
sidebarTitle: "LiveAvatar (HeyGen) + Cartesia Line"
description: "Give a deployed Cartesia Line agent a streaming avatar with the LiveAvatar (by HeyGen) Cartesia Agent Connector"
