...
<Check>Last verified: 2026-07-07</Check>
...
<Steps>
  ...
  <Step title="Write the Line agent" titleSize="h3">
    ...
    def current_line_model() -> str:
        return (os.getenv("LINE_MODEL") or DEFAULT_LINE_MODEL).strip() or DEFAULT_LINE_MODEL
