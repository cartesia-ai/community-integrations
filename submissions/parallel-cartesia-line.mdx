...
Use [Parallel Search](https://docs.parallel.ai/search/search-quickstart) as a [loopback tool](/line/sdk/tools) in a [Cartesia Line agent](/line/sdk/agents). The agent retrieves current web results during the voice turn and answers directly in short spoken sentences.
...
<Steps>
  ...
  <Step title="Run the agent" titleSize="h3">
    ...
    The agent greets you, runs `web_search` for current-information questions, and answers in two to four spoken sentences without reading citations or URLs aloud.
  </Step>
