...
Community integration by **TrueFoundry**.
...
<Steps>
  ...
  <Step title="Add Cartesia Account Details">
    ...
    <Frame caption="Cartesia Model Account Form">
      <img src="/assets/images/integrations/truefoundry/cartesia2.png" alt="Cartesia account configuration form with fields for API key and collaborators" />
    </Frame>
  </Step>
  ...
  <Step title="Add Models">
    ...
    <Frame caption="Add Cartesia Model">
      <img src="/assets/images/integrations/truefoundry/cartesia3.png" alt="Add Cartesia model form with display name, model ID, and model type" />
    </Frame>
