...
<CardGroup cols={2}>
  ...
  <Card title="Cartesia TTS API reference" icon="book" href="/api-reference/tts/tts">
    Cartesia TTS HTTP API reference.
  </Card>

  <Card title="Cartesia STT API reference" icon="book" href="/api-reference/stt/transcribe">
