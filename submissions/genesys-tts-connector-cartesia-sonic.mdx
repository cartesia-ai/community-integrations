...
developer_docs: "https://help.genesys.cloud/articles/install-the-genesys-tts-connector-integration/"
---
...
<Steps>
  <Step title="Open the Genesys TTS Connector integration">
    ...
    <Frame>
      <img src="/assets/images/integrations/genesys-tts-connector/add-integration.png" alt="Genesys Cloud integrations page showing the Genesys TTS Connector integration" />
    </Frame>
  </Step>
  ...
  <Step title="Configure properties">
    ...
    <Frame>
      <img src="/assets/images/integrations/genesys-tts-connector/config-properties.png" alt="Genesys TTS Connector properties configured for Cartesia" />
    </Frame>
  </Step>

  <Step title="Set the advanced JSON configuration">
    ...
    <Frame>
      <img src="/assets/images/integrations/genesys-tts-connector/config-advanced.png" alt="Genesys TTS Connector advanced JSON configuration for Cartesia" />
    </Frame>
  </Step>
...
<Step title="Add credentials">
  ...
  <Frame>
    <img src="/assets/images/integrations/genesys-tts-connector/config-credentials.png" alt="Genesys TTS Connector credentials configured with Cartesia API headers" />
  </Frame>
</Step>
...
<Step title="Save and activate the integration">
  ...
  <Frame>
    <img src="/assets/images/integrations/genesys-tts-connector/integration-error-and-active.png" alt="Genesys TTS Connector integrations in an error and active state" />
  </Frame>
</Step>

<Step title="Try out Sonic">
  ...
  <Frame>
    <img src="/assets/images/integrations/genesys-tts-connector/architect-usage.png" alt="Genesys Architect using Cartesia voices through the Genesys TTS Connector integration" />
  </Frame>
</Step>
</Steps>
...
- [Genesys TTS Engine](https://help.genesys.cloud/articles/about-text-to-speech-tts-engines/)  
  Genesys text-to-speech documentation
- [Genesys TTS Connector](https://help.genesys.cloud/articles/install-the-genesys-tts-connector-integration/)  
  Genesys integration documentation
- [Pricing](https://www.cartesia.ai/pricing)  
  Cartesia's subscription plans and their limits
- [Subscription](https://play.cartesia.ai/subscription)  
  Manage your Cartesia subscription
- [API Keys](https://play.cartesia.ai/keys)  
  Create and manage Cartesia API keys
- [Output Format](/build-with-cartesia/capability-guides/tts-output-audio-format)  
  How to find the right parameters for output audio
- [Choosing a voice](/build-with-cartesia/capability-guides/choosing-a-voice)  
  How to pick the best voice for your agents
- [Voice Library](https://play.cartesia.ai/voices)  
  Try out voices for Sonic in the Cartesia playground
